...
CETidyByDateReadParams1Step::CETidyByDateReadParams1Step()
/** Each test step initialises it's own name
*/
	{
	// store the name of this test case
	// this is the name that is used by the script file
	//DEF iTestStepName = _L("CETidyByDateReadParams1Step");
...
*/
TInt CETidyByDateReadParams1Step::Exec_SendReceive()
	{
