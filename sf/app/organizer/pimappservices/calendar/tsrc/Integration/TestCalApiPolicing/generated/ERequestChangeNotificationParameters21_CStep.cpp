...
CERequestChangeNotificationParameters21Step::CERequestChangeNotificationParameters21Step()
/** Each test step initialises it's own name
*/
	{
	// store the name of this test case
	// this is the name that is used by the script file
	//DEF iTestStepName = _L("CERequestChangeNotificationParameters21Step");
...
*/
TInt CERequestChangeNotificationParameters21Step::Exec_SendReceive()
	{
