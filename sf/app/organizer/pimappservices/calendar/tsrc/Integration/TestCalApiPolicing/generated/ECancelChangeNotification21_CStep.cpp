...
CECancelChangeNotification21Step::CECancelChangeNotification21Step()
/** Each test step initialises it's own name
*/
	{
	// store the name of this test case
	// this is the name that is used by the script file
	//DEF iTestStepName = _L("CECancelChangeNotification21Step");
...
*/
TInt CECancelChangeNotification21Step::Exec_SendReceive()
	{
