...
CERequestChangeNotification21Step::CERequestChangeNotification21Step()
/** Each test step initialises it's own name
*/
	{
	// store the name of this test case
	// this is the name that is used by the script file
	//DEF iTestStepName = _L("CERequestChangeNotification21Step");
...
*/
TInt CERequestChangeNotification21Step::Exec_SendReceive()
	{
