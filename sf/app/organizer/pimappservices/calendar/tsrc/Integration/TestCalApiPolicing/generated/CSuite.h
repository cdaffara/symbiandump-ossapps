...
//
// Description:
// This contains CTestTestCalApiPolicingSuite 
// 
//

#ifndef CAP_TestCalApiPolicing_SERVER_H_
#define CAP_TestCalApiPolicing_SERVER_H_
...
class  CTestTestCalApiPolicingServer : public CTestServer
{
public:
	static CTestTestCalApiPolicingServer* NewL();
...
public:
	...
	TInt StartServer() ;
	TInt WaitForSomeTimeAndDecide(TRequestStatus& aStatus);
	TInt GetSyncOrAsync(TInt aMessageNo);
...
#endif /* TS_TestCalApiPolicing_SERVER_H_ */
