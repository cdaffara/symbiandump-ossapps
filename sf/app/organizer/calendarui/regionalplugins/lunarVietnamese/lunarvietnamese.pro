...
# Contributors:
#
# Description: Project file for Lunarvietnamese plugin module.
#

TEMPLATE = lib
CONFIG += hb
TARGET = calenlunarvietnameseplugin
...
"APP_LAYER_SYSTEMINCLUDE" \
	\
"SOURCEPATH      ./data" \
"START RESOURCE hb_calenlunarvietnameseplugin.rss" \
"TARGET hb_calenlunarvietnameseplugin.rsc" \
...
TARGET.UID3 = 0x102823AA #CALENVIETNAMESEPLUGIN_DLL_UID 
TARGET.CAPABILITY = CAP_ECOM_PLUGIN 

}
# Input
HEADERS += ./inc/calenlunarvietnameselocalizer.h \
		   ./inc/calenlunarvietnameseplugin.h	

SOURCES +=  ./src/calenlunarvietnameseplugin.cpp \
            ./src/calenlunarvietnamesepluginproxy.cpp \
			./src/calenLunarvietnameselocalizer.cpp
