...
#ifndef AgnParseRRuleDaily_H
#define AgnParseRRuleDaily_H

#include "AgnParseRRule.h"

class CAgnParseRRuleDaily : CAgnParseRRule
    {
    public:
    	CAgnParseRRuleDaily();
    	virtual ~CAgnParseRRuleDaily();
    
    public:
        static CAgnParseRRule* NewLC( MAgnImpUtil& aAgnImpUtil );
    
    private://Constructor
        CAgnParseRRuleDaily( MAgnImpUtil& aAgnImpUtil );
