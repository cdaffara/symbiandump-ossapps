...
#ifndef CTESTIMAPSEARCH_H
#define CTESTIMAPSEARCH_H
...
/**
This test fixture tests CImapSearch.
@internalTechnology
@prototype
*/
class CTestImapSearch : public CActiveTestFixture
...
public:
	...
	// Tests
	void TestSimpleSearchL();
	void TestSearchWithMessageL();
